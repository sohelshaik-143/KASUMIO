...
public class VerificationDetailResponse {
    ...
    public VerificationDetailResponse() {}

    public VerificationDetailResponse(Long id, Long opportunityId, String opportunityTitle, OpportunityType opportunityType,
                                    String candidateAlias, Long evidenceId, String evidenceTitle, String evidenceDescription,
                                    String evidenceUrl, EvidenceType evidenceType, String skillName, String skillCategory,
                                    VerificationStatus status, Instant requestedAt, Instant respondedAt,
                                    String recruiterComment, boolean hasExpressedInterest) {
        this.id = id;
